  ...
  const bonuses = [
    {
      ...
      description: "nikdy nebudeš přemýšlet, co postnout, protože Ti to řeknou Tví sledující..",
      icon: "🎯"
    },
    {
      title: "BONUS 2: Podceňovaný HACK",
      description: "který nastavíš za 5 minut a zvýší Tvůj zisk už v soukromých zprávách (bez ručního vypisování)",
      icon: "⚡"
    }
  ];
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-r from-green-400/15 to-green-600/10 backdrop-blur-md p-10 rounded-2xl border border-green-400/20 mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-3xl font-bold text-green-400">MINIKURZ pro začátečníky</h3>
            </div>
            ...
            <div className="bg-black/30 p-6 rounded-xl border-l-4 border-green-400">
              <p className="text-gray-300 leading-relaxed">
                ...
                <span className="text-green-400 font-semibold"> Jak funguje algoritmus na Instagramu </span>
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-r from-green-400/20 to-green-600/10 backdrop-blur-md p-10 rounded-2xl border border-green-400/30 mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-3xl font-bold text-green-400">3-Fázový GrowMat Systém</h3>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {minicourseFeatures.map((feature, index) => (
              <div key={index} className="group bg-white/5 backdrop-blur-md border border-gray-700/50 rounded-2xl p-6 hover:border-green-400/50 transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8">
            {bonuses.map((bonus, index) => (
              <div key={index} className="bg-gradient-to-r from-green-400/15 to-green-600/10 backdrop-blur-md p-8 rounded-2xl border border-green-400/30 hover:border-green-400/50 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <FaGift className="text-green-400 text-2xl flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-xl font-bold text-green-400 mb-3">{bonus.title}</h4>
