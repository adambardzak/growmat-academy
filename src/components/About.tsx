...
import { FaUser, FaPodcast, FaLightbulb, FaGraduationCap, FaArrowRight, FaInstagram, FaPlay } from 'react-icons/fa';
        ...
        <div className="text-center mb-16">
          ...
          <div className="bg-gradient-to-r from-green-400/10 to-green-600/5 p-8 rounded-2xl border border-green-400/20 backdrop-blur-sm">
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-6">
              a buduji na Instagramu profily, které transformují lidem životy v oblasti zdraví.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white/5 backdrop-blur-md border border-gray-700/50 rounded-2xl p-8 hover:border-green-400/30 transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-xl font-semibold text-green-400">Můj začátek</h4>
            </div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Když jsem začínal s mým prvním projektem - podcast <span className="text-green-400 font-semibold">Sober Boys</span>
              - neměl jsem absolutně tušení jak být virální, editovat videa či jak se vůbec 
              na sociálních sítích prosadit..
            </p>
            <p className="text-gray-300 leading-relaxed mb-6">
              Všechny dovednosti a know-how jsem tedy testoval metodou pokus/omyl jak
              na svých projektech, tak i na prvních klientech, kteří ve mě vložili důvěru.
            </p>
          ...
          <div className="bg-gradient-to-br from-green-400/10 to-green-600/5 backdrop-blur-md border border-green-400/20 rounded-2xl p-8 hover:border-green-400/40 transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-xl font-semibold text-green-400">GrowMat Academy</h4>
            </div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Do GrowMat Academy jsem vložil veškeré své know-how prakticky a provádím Tě 
              krok za krokem od samotného založení profilu až po první prodeje.
            </p>
            <div className="bg-black/20 p-4 rounded-xl border-l-4 border-green-400 mb-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                Protože kdybych na svém začátku měl místo, kde se od A do Z naučím
                Jak úspěšně budovat osobní brand na Instagramu 
